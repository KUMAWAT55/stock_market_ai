# Day 33: Indicator Heatmap Rendering

## Goal
Bullish/bearish classification display logic

## App Flow Focus
How indicator states are computed and shown

## Read in This Repo
- api/analytics.py, features/indicators.py, webapp/src/pages/DashboardPage.tsx

## Hands-On Work (90 to 120 mins)
1. Read the target files and write 5 to 10 bullet notes in your own words.
2. Complete this task: Trace one indicator row from DB to heatmap cell
