# Day 16: Database Manager Layer

## Goal
How DatabaseManager abstracts SQL

## App Flow Focus
How API reads and writes through db_manager
...
2. Complete this task: Find methods used by /dashboard/snapshot and /auth routes
