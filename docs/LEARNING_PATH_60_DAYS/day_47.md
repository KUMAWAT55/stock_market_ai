# Day 47: Historical Backfill Automation

## Goal
Automatic ensure loop and freshness policy

## App Flow Focus
How missing latest data triggers backfill jobs

## Read in This Repo
- api/main.py, config/config.py, .env.example

## Hands-On Work (90 to 120 mins)
1. Read the target files and write 5 to 10 bullet notes in your own words.
2. Complete this task: Tune ensure interval/max jobs locally and observe logs
3. Capture one blocker and how you resolved it.

## End-of-Day Output
- Backfill automation tuning notes
