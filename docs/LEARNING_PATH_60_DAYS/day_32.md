# Day 32: Model Matrix Rendering

## Goal
Displaying multi-timeframe model outcomes

## App Flow Focus
How prediction confidence becomes table UI

## Read in This Repo
- webapp/src/pages/DashboardPage.tsx, api/analytics.py

## Hands-On Work (90 to 120 mins)
1. Read the target files and write 5 to 10 bullet notes in your own words.
2. Complete this task: Map matrix backend fields to UI columns
3. Capture one blocker and how you resolved it.

## End-of-Day Output
- Matrix field mapping sheet
