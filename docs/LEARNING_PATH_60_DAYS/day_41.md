# Day 41: Model Registry and Versioning

## Goal
Selecting active model by timeframe

## App Flow Focus
How versioned artifacts are resolved safely

## Read in This Repo
- models/model_registry.py, models/artifacts

## Hands-On Work (90 to 120 mins)
1. Read the target files and write 5 to 10 bullet notes in your own words.
2. Complete this task: Inspect active models per timeframe and versions
3. Capture one blocker and how you resolved it.

## End-of-Day Output
- Versioning audit note
