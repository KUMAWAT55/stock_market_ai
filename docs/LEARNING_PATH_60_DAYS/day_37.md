# Day 37: Feature Engineering Pipeline

## Goal
How raw candles become model features

## App Flow Focus
Where indicators and transforms are applied

## Read in This Repo
- features/feature_pipeline.py, features/indicators.py

## Hands-On Work (90 to 120 mins)
1. Read the target files and write 5 to 10 bullet notes in your own words.
2. Complete this task: Trace one feature value from source columns
