# Day 49: Week 7 Review Full Trace

## Goal
Consolidate realtime + backfill + risk understanding

## App Flow Focus
Full path from websocket tick to dashboard card

## Read in This Repo
- data/kite_client.py, realtime/realtime_engine.py, api/main.py, webapp/src/pages/DashboardPage.tsx

## Hands-On Work (90 to 120 mins)
1. Read the target files and write 5 to 10 bullet notes in your own words.
2. Complete this task: Create one full sequence diagram
