# Day 8: FastAPI Core Concepts

## Goal
Routes, decorators, models, response design

## App Flow Focus
How endpoints are registered and served
...
2. Complete this task: Map all endpoint groups by purpose
3. Capture one blocker and how you resolved it.

## End-of-Day Output
- Endpoint catalog grouped by feature
