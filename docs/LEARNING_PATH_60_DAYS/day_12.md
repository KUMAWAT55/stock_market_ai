# Day 12: Error Handling and Reliability

## Goal
HTTPException patterns and safe fallbacks

## App Flow Focus
How degraded mode works when DB is unavailable
...
2. Complete this task: Simulate one failure scenario and inspect returned error
3. Capture one blocker and how you resolved it.

## End-of-Day Output
- Failure-to-response mapping note
