# Day 34: Backtest and Scanner UX

## Goal
How to present strategy outcomes clearly

## App Flow Focus
How analytics endpoints feed decision support

## Read in This Repo
- api/main.py, api/analytics.py, webapp/src/pages/DashboardPage.tsx

## Hands-On Work (90 to 120 mins)
1. Read the target files and write 5 to 10 bullet notes in your own words.
2. Complete this task: Test scanner filters and compare outputs
3. Capture one blocker and how you resolved it.

## End-of-Day Output
- Scanner behavior checklist
