# Day 23: TypeScript Essentials

## Goal
Types, interfaces, strict mode mindset

## App Flow Focus
How type safety prevents UI runtime bugs

## Read in This Repo
- webapp/tsconfig.json, webapp/src/api.ts

## Hands-On Work (90 to 120 mins)
1. Read the target files and write 5 to 10 bullet notes in your own words.
2. Complete this task: Add or refine one interface for API response locally
3. Capture one blocker and how you resolved it.

## End-of-Day Output
- Type safety diff note
