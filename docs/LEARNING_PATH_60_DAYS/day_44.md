# Day 44: Kite Client and Tick Ingestion

## Goal
Websocket events and subscription flow

## App Flow Focus
How broker stream enters internal processing

## Read in This Repo
- data/kite_client.py, realtime/realtime_engine.py

## Hands-On Work (90 to 120 mins)
1. Read the target files and write 5 to 10 bullet notes in your own words.
2. Complete this task: Trace on_connect and tick handler path
3. Capture one blocker and how you resolved it.

## End-of-Day Output
- Tick ingestion sequence
