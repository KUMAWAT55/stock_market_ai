# Day 50: Testing Strategy

## Goal
Unit vs integration vs smoke tests

## App Flow Focus
Where tests should exist in this architecture

## Read in This Repo
- README.md, api/main.py, webapp/src

## Hands-On Work (90 to 120 mins)
1. Read the target files and write 5 to 10 bullet notes in your own words.
2. Complete this task: Draft a test plan for auth and dashboard APIs
