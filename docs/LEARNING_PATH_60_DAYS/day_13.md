# Day 13: CORS and Browser Networking

## Goal
Why CORS exists and how this app allows LAN access

## App Flow Focus
How browser OPTIONS and actual requests differ

## Read in This Repo
- api/main.py, .env.example

## Hands-On Work (90 to 120 mins)
1. Read the target files and write 5 to 10 bullet notes in your own words.
2. Complete this task: Trigger OPTIONS preflight and confirm CORS headers
