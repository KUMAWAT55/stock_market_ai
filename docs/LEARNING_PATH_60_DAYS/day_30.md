# Day 30: Dashboard Snapshot Contract

## Goal
Understand one consolidated payload deeply

## App Flow Focus
How one API powers multiple dashboard widgets

## Read in This Repo
- api/main.py, webapp/src/pages/DashboardPage.tsx

## Hands-On Work (90 to 120 mins)
1. Read the target files and write 5 to 10 bullet notes in your own words.
2. Complete this task: Document every top-level field of snapshot response
