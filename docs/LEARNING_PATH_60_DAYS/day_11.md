# Day 11: Async and Concurrency Basics

## Goal
async def, await, locks, tasks

## App Flow Focus
How ensure jobs run in background without blocking UI
...
2. Complete this task: Trace _queue_ensure_if_needed and _run_ensure_job
3. Capture one blocker and how you resolved it.

## End-of-Day Output
- Concurrency notes with examples
