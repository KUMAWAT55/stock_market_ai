...
## Goal
How .env values drive runtime behavior

## App Flow Focus
How settings influence API, engine, and sync behavior

## Read in This Repo
- .env.example, config/config.py

## Hands-On Work (90 to 120 mins)
1. Read the target files and write 5 to 10 bullet notes in your own words.
2. Complete this task: Change one non-critical env var and verify behavior difference
3. Capture one blocker and how you resolved it.

## End-of-Day Output
- Config matrix of key env vars and impact
