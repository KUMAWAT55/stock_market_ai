# Day 42: Week 6 Review ML-to-UI

## Goal
Connect ML internals to dashboard presentation

## App Flow Focus
How model confidence appears in terminal

## Read in This Repo
- models/predict.py, api/analytics.py, webapp/src/pages/DashboardPage.tsx

## Hands-On Work (90 to 120 mins)
1. Read the target files and write 5 to 10 bullet notes in your own words.
2. Complete this task: Create one end-to-end field lineage table
3. Capture one blocker and how you resolved it.

## End-of-Day Output
- ML field lineage table
