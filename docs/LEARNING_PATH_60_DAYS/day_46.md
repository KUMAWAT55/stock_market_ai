# Day 46: Risk Manager and Guardrails

## Goal
Simulation-only risk filters and approvals

## App Flow Focus
How raw model signal becomes approved signal

## Read in This Repo
- compliance/risk_manager.py, api/main.py

## Hands-On Work (90 to 120 mins)
1. Read the target files and write 5 to 10 bullet notes in your own words.
2. Complete this task: Map risk reasons to UI-visible fields
