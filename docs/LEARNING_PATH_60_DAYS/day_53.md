# Day 53: Intraday Product Thinking

## Goal
User personas, workflows, and feature priorities

## App Flow Focus
How intraday traders use scanner, chart, and matrix

## Read in This Repo
- docs/INTRADAY_PRODUCT_ROADMAP.md, webapp/src/pages/HomePage.tsx

## Hands-On Work (90 to 120 mins)
1. Read the target files and write 5 to 10 bullet notes in your own words.
2. Complete this task: Write 3 user stories for intraday trader personas
