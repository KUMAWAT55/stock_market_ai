# Day 39: Training Pipeline Internals

## Goal
Data prep, hyperparams, artifact outputs

## App Flow Focus
How model files and metadata are produced

## Read in This Repo
- models/train.py, config/model_hyperparams.json

## Hands-On Work (90 to 120 mins)
1. Read the target files and write 5 to 10 bullet notes in your own words.
2. Complete this task: Run or dry-run training command and inspect artifacts
